document.addEventListener('DOMContentLoaded', function() {
    ...
    // Function to increment the amount of cart items by 1
    function incrementCartItem(itemName) {
        ...
        if (correspondingCartItem) {
            ...
            currentAmount += 1; // Always increment by 1
            ...
            updateQuantityControl(itemName, currentAmount); // Update quantity control amount
    ...
    // Function to decrement the amount of cart items by 1
    function decrementCartItem(itemName) {
        ...
        if (correspondingCartItem) {
            ...
            currentAmount = Math.max(1, currentAmount - 1); // Always decrement by 1, but not below 1
            amountElement.setAttribute('amount', currentAmount);
            amountElement.textContent = currentAmount;
            console.log('Updated cart item amount:', currentAmount);
            updateSubCartItems(itemName, currentAmount); // Update sub-cart-item amounts
    ...
    function updateSubCartItems(itemName, currentAmount) {
        ...
        subCartItems.forEach(subCartItem => {
            ...
            subCartItem.classList.add('default-styling-class'); // Replace with the actual class name used in Webflow
    ...
    function updateCustomizationPanel(itemName) {
        ...
        if (customizationPanel) {
            ...
            if (descriptionElementTab1 && descriptionElementTab1.style.display === 'block') {
                if (descriptionElementTab2) {
    ...
    function removeSelectedItem() {
        ...
        if (cartItem) {
            ...
            const mealTagElement = cartItem.querySelector('.order-item-price-container .item-content .cart-item-info .meal-tag');
            if (mealTagElement) {
