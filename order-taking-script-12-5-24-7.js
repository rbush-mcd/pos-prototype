document.addEventListener('DOMContentLoaded', function() {
    ...
    function removeSelectedItem() {
        ...
        if (cartItem) {
            ...
            const sizeControlButtons = document.querySelectorAll(`#drink-selection .customization-content[data-cart-customization-content="${selectedItemName}"] .size-control .button.is--size-control[data-size="L"]`);
            sizeControlButtons.forEach(button => {
