document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleDrinkSelectionClick(event) {
        ...
        const mealReviewDrinkItemElement = document.querySelector('#meal-review .customization-step #meal-item-drink .meal-item #meal-drink-item');
        if (mealReviewDrinkItemElement) {
            mealReviewDrinkItemElement.textContent = drinkName;
        ...
        const mealReviewDrinkImageElement = document.querySelector('#meal-review .customization-step #meal-item-drink .meal-item .menu-item-image');
