document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateSizeTextBlocks(size, cartItem) {
        const mealItemSizeElement = cartItem.querySelector('#meal-item-size[data-size="meal-item-size"]');
    ...
    function handleSizeControlClick(event) {
        ...
        const mealItem = sizeControlButton.closest('.meal-item');
        ...
        const newSize = size === 'large' ? 'L' : 'M';
        updateSizeTextBlocks(newSize, correspondingCartItem);
    }
