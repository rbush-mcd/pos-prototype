document.addEventListener('DOMContentLoaded', function() {
    ...
    function incrementCartItem(itemName, quantity = 1) {
        ...
        if (correspondingCartItem) {
            ...
            // Update the sub-cart-item amounts
            ...
            subCartItems.forEach(subCartItem => {
                ...
                // Ensure the default styling is retained
...
document.querySelectorAll('#make-meal').forEach(button => {
    button.addEventListener('click', function() {
        ...
        const mealTagElement = correspondingCartItem.querySelector('.order-item-price-container .item-content .cart-item-info .meal-tag');
        if (mealTagElement) {
