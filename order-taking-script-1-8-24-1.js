document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleDrinkSelectionClick(event) {
        ...
        // Update the menu-item-image in the meal-item-drink element in the cart item
        const mealDrinkImageElement = correspondingCartItem.querySelector('#meal-item-drink .meal-item .menu-item-image');
        if (mealDrinkImageElement) {
            mealDrinkImageElement.src = drinkImageSrc;
            console.log('Updated meal-drink-item image to:', drinkImageSrc);
        }
    
        // Update the meal-drink-item text in the meal-review customization step
        const mealReviewDrinkItemElement = document.querySelector(`#meal-review .customization-step .customization-content[data-cart-customization-content="${selectedItemName}"] #meal-item-drink .meal-item #meal-drink-item`);
        if (mealReviewDrinkItemElement) {
            mealReviewDrinkItemElement.innerText = drinkName;
            mealReviewDrinkItemElement.setAttribute('data-meal-drink-title', drinkName);
        ...
        const mealReviewDrinkImageElement = document.querySelector(`#meal-review .customization-step .customization-content[data-cart-customization-content="${selectedItemName}"] #meal-item-drink .meal-item .menu-item-image`);
